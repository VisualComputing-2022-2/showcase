...
function preload() {
  ...
  truchetShader = readShader('/showcase/sketches/shaders/procedural_texturing/truchet.frag', { matrices: Tree.NONE, varyings: Tree.NONE });
  bricksShader = readShader('/showcase/sketches/shaders/procedural_texturing/bricks.frag', { matrices: Tree.NONE, varyings: Tree.NONE });
  decoShader = readShader('/showcase/sketches/shaders/procedural_texturing/deco.frag', { matrices: Tree.NONE, varyings: Tree.NONE });
  linesShader = readShader('/showcase/sketches/shaders/procedural_texturing/lines.frag', { matrices: Tree.NONE, varyings: Tree.NONE });
  mirrorShader = readShader('/showcase/sketches/shaders/procedural_texturing/mirror.frag', { matrices: Tree.NONE, varyings: Tree.NONE });
  waveShader = readShader('/showcase/sketches/shaders/procedural_texturing/wave.frag', { matrices: Tree.NONE, varyings: Tree.NONE });
  zigzagShader = readShader('/showcase/sketches/shaders/procedural_texturing/zigzag.frag', { matrices: Tree.NONE, varyings: Tree.NONE });
}
